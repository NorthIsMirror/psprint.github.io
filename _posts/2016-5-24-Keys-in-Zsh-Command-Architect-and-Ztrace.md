---
layout: post
title: Keys in Zsh Command Architect and Ztrace
---

Below are keyboard shortcuts for
[Zsh Command Architect](https://github.com/psprint/zsh-cmd-architect).
For [Ztrace](https://github.com/psprint/ztrace), they are the same, with
one additional key: `Ctrl-E`, that switches between Ztrace view and
History view.
